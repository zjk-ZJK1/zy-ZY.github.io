...
<script type="text/javascript">
	function toExcel(){
        $('#dg').datagrid('toExcel','daochu.xls');	// export to excel
    }
	function print(){
...
<!--startprint-->
	...
	<div id="tb">
		<div>
			...
			<a href="javascript:shangchuanShuju()" class="easyui-linkbutton" iconCls="icon-add" plain="true">上传图片</a>
			<a href="javascript:deleteShuju()" class="easyui-linkbutton" iconCls="icon-remove" plain="true">删除</a>
			<a href="javascript:shangjiaShuju()" class="easyui-linkbutton" iconCls="icon-add" plain="true">运行</a>
			<a href="javascript:xiajiaShuju()" class="easyui-linkbutton" iconCls="icon-remove" plain="true">关闭</a>
			<a href="javascript:toExcel()" class="easyui-linkbutton" iconCls="icon-add" plain="true">导出</a>
			<a href="javascript:print()" class="easyui-linkbutton" iconCls="icon-add" plain="true">打印</a>
		</div>
		<div>
