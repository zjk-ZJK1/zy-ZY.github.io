...
<!--startprint-->
	<table id="dg" title="个人信息" class="easyui-datagrid" fitColumns="true"
	 pagination="true" url="../getYonghus?yonghuId=<%=yonghuId %>" fit="true" rownumbers="true" toolbar="#tb" nowrap="false">
		<thead>
			<tr>
				...
				<th field="yonghuMark" width="20">职称</th>
				<th field="yonghuMark1" width="60">特长</th>
				<th field="yonghuDate" width="20" formatter="datetostr" hidden="true">时间</th>
			</tr>
		</thead>
	</table>
