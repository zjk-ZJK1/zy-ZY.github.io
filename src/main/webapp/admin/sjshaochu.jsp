...
<!--startprint-->
	<table id="dg" title="<%=newJcpeizhi.getShujuBieming()%><%=newJcpeizhi.getSjshaochuBieming()%>" class="easyui-datagrid" fitColumns="true"
	 pagination="true" url="../getSjshaochus" fit="true" rownumbers="true" toolbar="#tb" nowrap="false">
		<thead>
			<tr>
	...
	<div id="tb">
		<div>
			<a href="javascript:openSjshaochuModifyDialog()" class="easyui-linkbutton" iconCls="icon-edit" plain="true">回复</a>
	...
	<div id="dlg" class="easyui-dialog" style="width: 380px;height: 220px;padding: 10px 20px"
		...
		<form id="fm" method="post">
			<table>
				<tr>
					<td valign="top">回复：</td>
					<td><textarea rows="7" cols="30" name="sjshaochuMark2" id="sjshaochuMark2"></textarea></td>
				</tr>
			</table>
		</form>
	</div>
