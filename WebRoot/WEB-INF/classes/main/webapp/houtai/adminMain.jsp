    ...
    <div class="container">
                ...
                <ul>
                    <li class="nav-item">
                        ...
                        <ul class="submenu" id="menu1">
                            <li><a href="<%=basePath%>admin/adminmima.jsp" target="contentFrame"><i class="fa fa-angle-right"></i> 修改密码</a></li>
                        </ul>
                    </li>
        ...
        <div class="main-content">
            ...
            <div class="top-bar">
                <div class="user-info">
                    <span>管理员</span>
                    <a href="<%=basePath%>admin/adminmima.jsp" target="contentFrame"><i class="fa fa-key"></i> 修改密码</a>
