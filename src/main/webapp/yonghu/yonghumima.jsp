...
#login .logo{height:78px; text-align:center; font-size:30px; font-weight:bold; color:#1A202C; margin-top:40px;}
...
#login .main form ul li .bnt{width:292px;border:0;background:#1A202C;color:#fff;border-radius:4px;padding:12px 0;margin:0;font-size:16px;font-family:microsoft yahei;cursor:pointer;}
