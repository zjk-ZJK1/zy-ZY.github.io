	 ...
	 pagination="true" url="../getSjduochus" fit="true" rownumbers="true" toolbar="#tb" nowrap="false">
		<thead>
			<tr>
				...
				<th field="sjduochuName" width="40">故障</th>
				<th field="sjduochuMark" width="40">位置</th>
				<th field="sjduochuMark1" width="60">说明</th>
				<th field="sjduochuMark2" width="80">详情</th>
	...
	<div id="dlg" class="easyui-dialog" style="width: 540px;height: 280px;padding: 10px 20px"
		...
		<form id="fm" method="post">
			<table cellspacing="5px;">
				...
				<tr>
					<td valign="top">详情：</td>
					<td colspan="4"><textarea rows="7" cols="55" name="sjduochuMark2" id="sjduochuMark2"></textarea></td>
				</tr>
			</table>
		</form>
	</div>
