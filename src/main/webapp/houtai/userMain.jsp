    ...
    <div class="container">
                ...
                <ul>
                    <li class="nav-item">
                        ...
                        <ul class="submenu" id="menu1">
                            <li><a href="<%=basePath%>user/user.jsp" target="contentFrame"><i class="fa fa-angle-right"></i> 个人信息</a></li>
                            <li><a href="<%=basePath%>user/usermima.jsp" target="contentFrame"><i class="fa fa-angle-right"></i> 修改密码</a></li>
                        </ul>
                    </li>
                    ...
                    <li class="nav-item">
                        ...
                        <ul class="submenu" id="menu<%=i+2%>">
                            ...
                            <li><a href="<%=basePath%>user/<%=jcdaohangslist.get(i).get(j).getJcdaohangNeirong() %>" target="contentFrame"><i class="fa fa-angle-right"></i> <%=jcdaohangslist.get(i).get(j).getJcdaohangName() %></a></li>
                            <%} %>
                        </ul>
                    </li>
                    <%} %>
        ...
        <div class="main-content">
            ...
            <div class="top-bar">
                <div class="user-info">
                    <span><%=userName %></span>
                    <a href="<%=basePath%>user/usermima.jsp" target="contentFrame"><i class="fa fa-key"></i> 修改密码</a>
