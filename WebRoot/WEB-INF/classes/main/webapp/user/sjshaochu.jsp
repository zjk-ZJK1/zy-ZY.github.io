...
<!--startprint-->
	<table id="dg" title="<%=newJcpeizhi.getShujuBieming()%><%=newJcpeizhi.getSjshaochuBieming()%>" class="easyui-datagrid" fitColumns="true"
	 pagination="true" url="../getSjshaochus?userId=<%=userId %>" fit="true" rownumbers="true" toolbar="#tb" nowrap="false">
		<thead>
			<tr>
				...
				<th field="sjshaochuName" width="40">故障</th>
				<th field="sjshaochuMark" width="60">状态</th>
				<th field="sjshaochuMark1" width="60">说明</th>
				<th field="sjshaochuImgName" width="10" formatter="formatXiazai">附件</th>
				<th field="sjshaochuMark2" width="60">回复</th>
	...
	<div id="tb">
		<div>
			<a href="javascript:openSjshaochuAddDialog()" class="easyui-linkbutton" iconCls="icon-add" plain="true">添加</a>
			<a href="javascript:openSjshaochuModifyDialog()" class="easyui-linkbutton" iconCls="icon-edit" plain="true">修改</a>
			<a href="javascript:shangchuanSjshaochu()" class="easyui-linkbutton" iconCls="icon-add" plain="true">上传附件</a>
